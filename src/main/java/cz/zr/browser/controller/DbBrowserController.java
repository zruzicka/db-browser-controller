...
public class DbBrowserController {
  ...
  /**
   * Returns all available connections. Pagination, sorting and filtering is not supported.
   */
  @ApiOperation(value = "Returns all available tables of selected DB connection. (Pagination, sorting and filtering is not supported.)", nickname = "getTables")
  @ApiResponses(value = {
